defmodule HabitsWeb.Router do
  ...
  import HabitsWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {HabitsWeb.Layouts, :root}
  ...
  scope "/", HabitsWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{HabitsWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", HabitsWeb do
    ...
    live_session :current_user,
      on_mount: [{HabitsWeb.UserAuth, :mount_current_user}] do
